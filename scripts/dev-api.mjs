...
const settings=[
  ...
  'OPENAI_API_KEY','OPENAI_REALTIME_MODEL','OPENAI_REALTIME_VOICE','OPENAI_CHAT_MODEL','OPENAI_REASONING_EFFORT','OPENAI_STT_MODEL','OPENAI_TTS_MODEL','OPENAI_TTS_VOICE',
];
